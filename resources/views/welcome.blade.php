        ...
        <div class="grid grid-cols-2 gap-8 w-10/12 xl:-mt-48">
            ...
            <div class="rounded-2xl w-full border-4 bg-gray-700
                ...
                <div class="bg-blue-400 p-3 w-1/2 text-black mb-2 text-right
                    ...
                    J'arrive, je me connecte !
                </div>
                <div class="bg-gray-300 p-3 w-1/2 text-black mb-8 clear-right
                    rounded-xl">
                    Leeez go !
                </div>
                <a class="inline-block rounded-full text-black p-2
                   ...
                   style="background-color:#ffffff">
                    <div class="h-full align-middle inline-block">Connection par
                        discord
                    </div>
                    <svg width="51" height="51" class="p-2
